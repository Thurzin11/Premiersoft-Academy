    ...
    <div className="p-8">
      <div className="flex justify-between items-center mb-8 p-3">
        <h1 className="text-3xl font-bold text-gray-800 text-center">
          ...
          <Link href={"categories/new"} className="bg-green-500 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 h-[50%]">
