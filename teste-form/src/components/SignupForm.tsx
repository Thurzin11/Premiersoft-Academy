...
const SignupForm = () => {
  ...
  return (
    <>
      <div className="h-[6vh] mb-3 flex flex-col ">
        <Link href="/" className="text-blue-500 font-bold w-[2%] text-[150%] text-center">
          &lt;
        </Link>
      </div>
      <Card className="w-full max-w-md mx-auto border mb-5">
        <CardHeader>
